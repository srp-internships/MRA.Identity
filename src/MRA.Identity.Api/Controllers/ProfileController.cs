...
public class ProfileController(IMediator mediator) : ControllerBase
{
    ...
    {
        var result = await mediator.Send(new GetUserSkillsQuery { UserName = userName });
        return Ok(result);
    }
    ...
    {
        var result = await mediator.Send(new RemoveUserSkillCommand { Skill = skill });
        return Ok(result);
    }
    ...
    {
        var result = await mediator.Send(new DeleteEducationCommand { Id = id });
        return Ok(result);
    }
    ...
    {
        var result = await mediator.Send(new GetAllEducationsQuery());
        return Ok(result);
    }
